...
因为 Java 并发涉及到的内容会非常多，本面试题可能很难覆盖到所有的知识点，所以推荐 [《深入拆解 Java 虚拟机》](http://gk.link/a/100kc) 。并且，本文会将面试题和该书的章节，大体保持一致。嘻嘻~

另外，本文涉及的面试题会超级超级超级多，所以艿艿已经分了小节，胖友要注意哟。

对于大部分 JVM 的面试题，基本都是概念题，所以艿艿一些面试题如果和 [《深入拆解 Java 虚拟机》](http://gk.link/a/100kc) 中，可以找到对应的章节，会进行注明。毕竟，看书可以理解更加深刻。

> 艿艿：因为和字节码、指令级，理解起来相对复杂，实际面试问的也相对少。所以，本文暂时先不写。当然，未来肯定要补的，这么有趣的东西，胖友说是不是。
...
![不同平台，不同 JVM](http://static.iocoder.cn/5f64c6b9436f6efbe54cfc2d01727301)
...
![img](http://static.iocoder.cn/images/JDK/2020_02_10/01.jpg)
...
![img](http://static.iocoder.cn/images/JDK/2020_02_10/02.png)
...
![img](http://static.iocoder.cn/images/JDK/2020_02_10/03.png)
...
JAVA 对象创建的过程，如下图所示：![JAVA 对象创建的过程](http://static.iocoder.cn/images/JDK/2020_02_10/06.png)
...
![JAVA 对象创建的过程](http://static.iocoder.cn/images/JDK/2020_02_10/07.png)
...
- 句柄定位：Java 堆会画出一块内存来作为句柄池，reference 中存储的就是对象的句柄地址，而句柄中包含了对象实例数据与类型数据各自的具体地址信息。![句柄定位](http://static.iocoder.cn/images/JDK/2020_02_10/04.png)
- 直接指针访问：Java 堆对象的不居中就必须考虑如何放置访问类型数据的相关信息，而 reference 中存储的直接就是对象地址。![直接指针访问](http://static.iocoder.cn/images/JDK/2020_02_10/05.png)
...
![标记-清除算法](http://static.iocoder.cn/f07ac7c68994aa21b7b4271073ea4e5b)
...
![标记-整理算法](http://static.iocoder.cn/52ea9a3813e09621c563b1cd4bdf0d22)
...
![复制算法](http://static.iocoder.cn/cc3f228ca5353fd5deb4b22b7a9709e6)
...
![分代收集算法](http://static.iocoder.cn/fec52af474f1250831d46b541e0fe7a9)
...
如下是一张对象创建时，分配内存的图：![内存分配](http://static.iocoder.cn/bc22a30cbe93b8dedda080144a73b613)
...
![堆](http://static.iocoder.cn/67796f9fc657b7b4dd0054f561248f5b)
...
![类加载器是如何加载 class 文件](http://static.iocoder.cn/images/JDK/2020_02_10/08.png)
...
![双亲委派模型](http://static.iocoder.cn/images/JDK/2020_02_10/09.png)
...
![脑图](http://static.iocoder.cn/f20e86724ff310733d7556bd203dc061)
